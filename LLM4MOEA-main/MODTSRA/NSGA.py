...
class NSGA2:
    ...
    def run(self):
        ...
        t = 1
        # 新增：保存每一代PF的路径到 NSGA2_multisat/PF_gen
        pf_gen_dir = os.path.join(project_path, 'ExperimentResult', self.instance_name, 'NSGA2_multisat', '1', 'PF_gen')
...
def NSGA2_run(instance_name, args):
    # 修改输出目录为 NSGA2_multisat
    alg_dir = os.path.join(project_path, 'ExperimentResult', instance_name, 'NSGA2_multisat')
