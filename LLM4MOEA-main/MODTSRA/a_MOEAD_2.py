...
def MOEAD_2_run(instance_name, args):
    alg_dir = project_path+'/ExperimentResult/' + instance_name + '/MOEAD_2/'
    ...
    for I in range(1, args.runTime + 1):
        ...
        startTime = time.time()
        moead = MOEAD_2(instance_name, args)
        EP_list = moead.run()
        endTime = time.time()
...
if __name__ == '__main__':
    ...
    args.save_dir = os.path.join(args.save_dir, instance_name, 'MOEAD_2')
    ...
    MOEAD_2_run(instance_name, args)
